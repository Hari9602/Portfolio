document.addEventListener('DOMContentLoaded', function () {
    ...
    if (terminalContent) {
        ...
        typeText(whoami, '$ whoami', function() {
            ...
            const descText = 'Passionate Cybersecurity Enthusiast and Purple Teamer exploring network security, digital forensics, and DevOps through hands-on CTFs and continuous learning.';
            const keywords = ['Cybersecurity Enthusiast', 'Purple Teamer', 'network security', 'digital forensics', 'DevOps', 'CTFs'];
